 ...
 * data source. 
 */
public class ThinningFilter extends AbstractSingleSourceFilter {
	public ThinningFilter() {
		input=null;
	}
    
    private ThinningFilter(ThinningFilter c,List<GraphElement> l) {
        super(c,l);
    ...
    @Override
    public ThinningFilter copy(List<GraphElement> l) {
        return new ThinningFilter(this,l);
    }
