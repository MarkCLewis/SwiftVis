...
public class FunctionFilter extends AbstractMultipleSourceFilter {
    public FunctionFilter() {
        valueEntry=new ArrayList<FunctionEntry>();
        paramEntry=new ArrayList<FunctionEntry>();
    }

    private FunctionFilter(FunctionFilter c,List<GraphElement> l) {
        super(c,l);
        valueEntry=new ArrayList<FunctionEntry>();
    ...
    @Override
    public FunctionFilter copy(List<GraphElement> l) {
        return new FunctionFilter(this,l);
    }
                    ...
                    public void execute(int start, int end) {
                        for(int i=start; i<end; ++i) {
                            for(int j=0; j<paramArray.length; j++) {
                                paramArray[j]=(int)(pForms[j].valueOf(FunctionFilter.this,ss,i));
                            }
                            for(int j=0; j<valueArray.length; j++) {
                                valueArray[j]=(float)(vForms[j].valueOf(FunctionFilter.this,ss,i));
                            }
